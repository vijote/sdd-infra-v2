...
resource "null_resource" "apply_app_backend" {
  ...
  triggers = {
    ...
    migrate_rev   = "015-2-quote-gate-fix"                         # 015-2: stdin bootstrap + single &&-chained gate
