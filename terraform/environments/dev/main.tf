...
resource "null_resource" "apply_app_backend" {
  ...
  triggers = {
    ...
    migrate_rev   = "015-7-recreate-on-apply"                      # 015-7: delete-before-apply (Job spec.template immutable)
