# Execution Graph (DAG): STS TagSession Role Enhancement

**Input**: Design documents from `/specs/001-2-sts-tagsession-role/`
...
- [x] T001 [Stage 1: CloudFormation] Add sts:TagSession permission to AssumeRolePolicyDocument Action list in `cloudformation/assume-role.yaml` (Depends on none)
