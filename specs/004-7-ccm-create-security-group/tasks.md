...
- [ ] T004 [Stage 2: Verify] AC-003: `terraform plan -no-color | grep -c 'ec2:CreateSecurityGroup'` returns `1` (and `ec2:AuthorizeSecurityGroupIngress` + `ec2:RevokeSecurityGroupIngress` present) (Depends on T001)
