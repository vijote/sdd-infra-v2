...
- [x] T003 [Stage 2: Static] AC-002: `grep -qF 'CommandInvocation.Status || Status' terraform/environments/dev/main.tf`
- [x] T004 [Stage 2: Static] AC-003: `! grep -qF "'CommandInvocation.Status'" terraform/environments/dev/main.tf`
