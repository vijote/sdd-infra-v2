...
- [x] T004 [Stage 2: Verify] AC-003: `terraform plan -no-color | grep -c 'elasticloadbalancing:\*'` returns `1` (and the granular `elasticloadbalancing:CreateLoadBalancer` etc. no longer present) (Depends on T001)
